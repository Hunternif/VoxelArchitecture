...
/**
 * Floor on an architectural plan. Can have arbitrary y level. Corridors can
 * only connect nodes on the same floor. Negative y level usually means dungeon.
 * <p><i>Possibly redundant?</i></p>
 * @author Hunternif
 */
