...
public class VerGateTest {
	...
	public void above() {
		...
		Room room2 = new Room(null, new Vec3(0, 2, 0), new Vec3(3, 2, 3), 0);
	...
	public void concentric() {
		...
		Room room2 = new Room(null, new Vec3(0, 2, 0), new Vec3(2, 2, 4), 0);
		Gate gate = gateFactory.create(room1, room2);
	...
	public void translated() {
		Room room1 = new Room(null, new Vec3(0, 0, 0), new Vec3(3, 3, 3), 0);
		Room room2 = new Room(null, new Vec3(2, 5, 0), new Vec3(2, 2, 4), 0);
		Gate gate = gateFactory.create(room1, room2);
		assertEquals(0, gate.getRotationY(), 0);
	...
	public void noGate() {
		Room room1 = new Room(null, new Vec3(0, 0, 0), new Vec3(3, 3, 3), 0);
		Room room2 = new Room(null, new Vec3(4, 2, 0), new Vec3(2, 2, 4), 0);
		Gate gate = gateFactory.create(room1, room2);
		assertNull(gate);
	}
}
