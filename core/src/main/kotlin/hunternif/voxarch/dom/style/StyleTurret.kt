...
val PropRoofOffset = newGenProperty<TurretGenerator, Double>("roof offset") { value ->
...
val PropSpireRatio = newGenProperty<TurretGenerator, Double>("spire ratio") { value ->
    val baseValue = 1.5
    gen.spireRatio = value.invoke(baseValue, seed + 10000014)
}

/** Y/X ratio of tapered bottoms of turrets. */
val PropTaperRatio = newGenProperty<TurretGenerator, Double>("taper ratio") { value ->
    val baseValue = 0.75
    gen.taperRatio = value.invoke(baseValue, seed + 10000015)
}

val PropRoofShape = newGenProperty<TurretGenerator, RoofShape>("roof shape") { value ->
...
//val PropBodyShape = newGenProperty<TurretGenerator, BodyShape>("body shape") { value ->
//    val baseValue = gen.bodyShape
//    gen.bodyShape = value.invoke(baseValue, seed + 10000008)
//}

val PropBottomShape = newGenProperty<TurretGenerator, BottomShape>("bottom shape") { value ->
