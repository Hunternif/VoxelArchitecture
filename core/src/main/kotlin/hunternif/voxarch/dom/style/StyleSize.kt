...
val PropHeight = newNodeProperty<Node, Dimension>("height") { value ->
...
val PropWidth = newNodeProperty<Node, Dimension>("width") { value ->
...
val PropLength = newNodeProperty<Node, Dimension>("length") { value ->
